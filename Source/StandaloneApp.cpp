...
namespace
{
class FoldKnifeStandaloneApplication final : public juce::JUCEApplication
{
public:
    FoldKnifeStandaloneApplication()
    {
...
START_JUCE_APPLICATION(FoldKnifeStandaloneApplication)
